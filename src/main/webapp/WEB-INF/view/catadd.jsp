		...
		<div class="pure-form" style="padding: 15px;">
			<form class="pure-form" method="post">
				<fieldset>
					...
					<input type="radio" id="yes" name="apply" value="apply_yes" /> 可申請領養
					<input type="radio" id="no" name="apply" value="apply_no" checked="" /> 不可申請領養
					<p />
					<button type="submit" class="button-secondary pure-button">新增</button>
					<a href="/catlist" class="button-error pure-button">取消</a>
				</fieldset>
			</form>
		</div>
	</body>
