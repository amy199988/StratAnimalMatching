...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> handlePasswordInvalidException(PasswordInvalidException ex, WebRequest request) {
	...
	public ResponseEntity<String> handleUserAlreadyExistsException(UserAlreadyExistsException ex, WebRequest request) {
		return new ResponseEntity<>("用戶帳號已存在" + ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<String> handleRequestNotFoundException(RequestNotFoundException ex, WebRequest request) {
