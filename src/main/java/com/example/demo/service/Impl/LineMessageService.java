...
public class LineMessageService {
  ...
  public String getReportSuccessMessage(String city, String district, String address,
      String description) {
    return LineMessageTemplate.REPORT_SUCCES.getMessage(city, district, address, description);
  }

  public String getReportUpdateMessgae(Integer reportNumber, String reportStatus,
      String lovehomeName, String lovehomeCity, String lovehomeDistrict, String lovehomeAddress) {
    return LineMessageTemplate.REPORT_UPDATE.getMessage(reportNumber, reportStatus, lovehomeName,
        lovehomeCity, lovehomeDistrict, lovehomeAddress);
  }
  ...
  public String getAdoptionUpdateMessage(Integer requestNumber, String requestStatus,
      String catName) {
    return LineMessageTemplate.ADOPTION_UPDATE.getMessage(requestNumber, requestStatus, catName);
  }

  public String getReportRequestMessage(String reportCity, String reportDistrict,
      String reportAddress, String description) {
    return LineMessageTemplate.REPORT_REQUEST.getMessage(reportCity, reportDistrict, reportAddress,
        description);
  }
