...
public class UserController {
  ...
  @GetMapping("/request")
  @CheckRole({"role_user", "role_manager"})
  public ResponseEntity<ApiResponse<List<AdoptionRequestDto>>> getUserAdoptionList(
      HttpSession session) {
    UserCert userCert = (UserCert) session.getAttribute("userCert");
    List<AdoptionRequestDto> adoptionRequestDtos = adoptionRequestService.getRequestsByuserId(
        userCert.getUserId());
